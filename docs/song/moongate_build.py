...
# (로즈 보이싱 4성부, 베이스 루트)
CH = {
    'Em9':     ([62, 66, 67, 71], 40),   # D F# G B   / E
    'A13':     ([61, 66, 67, 71], 45),   # C# F# G B  / A
    'F#m9':    ([64, 68, 69, 73], 42),   # E G# A C#  / F#
    'B7b13':   ([61, 63, 67, 69], 47),   # C# D# G A  / B
    'Bm9':     ([62, 66, 69, 73], 47),   # D F# A C#  / B
    'C#m7b5':  ([64, 67, 71, 73], 49),   # E G B C#   / C#
    'F#7b9':   ([61, 64, 67, 70], 42),   # C# E G A#  / F#
    'Gmaj9':   ([66, 69, 71, 74], 43),   # F# A B D   / G
    'A7':      ([61, 64, 67, 71], 45),   # C# E G B   / A
    'A7sus4':  ([62, 67, 69, 74], 45),   # D G A D    / A
    'D69':     ([64, 66, 69, 71], 38),   # E F# A B   / D
    'D/F#':    ([62, 66, 69, 74], 42),   # D F# A D   / F#
    'Gm6':     ([62, 64, 67, 70], 43),   # D E G Bb   / G   ★차용화음
    # ── E major (전조 구간)
    'Amaj9':   ([68, 71, 73, 76], 45),
    'B7':    ([63, 66, 69, 73], 47),
    'G#m9':    ([66, 70, 71, 75], 44),
    'C#m9':    ([64, 68, 71, 75], 49),
    'E69':     ([66, 68, 71, 73], 40),
    'B7sus4':  ([64, 69, 71, 76], 47),
...
# (마디, 박, 길이, 음, 음절)
CHORUS_MEL = [
    (1, 0.0, 0.5, 69, 'O'), (1, 0.5, 0.5, 71, 'pen'), (1, 1.0, 0.5, 71, 'the'),
    (1, 1.5, 1.0, 74, 'moon'), (1, 2.5, 0.5, 71, 'gate'),
    (2, 0.0, 0.5, 69, 'let'), (2, 0.5, 0.5, 71, 'the'), (2, 1.0, 1.0, 69, 'eve'),
    (2, 2.0, 0.5, 66, 'ning'), (2, 2.5, 1.5, 64, 'in'),
    (3, 0.0, 0.5, 66, 'I'), (3, 0.5, 0.5, 66, 'have'), (3, 1.0, 0.5, 69, 'fal'),
    (3, 1.5, 0.5, 69, 'len'), (3, 2.0, 0.5, 69, 'a'), (3, 2.5, 0.5, 71, 'thou'),
    (3, 3.0, 0.5, 69, 'sand'), (3, 3.5, 0.5, 66, 'times'),
    (4, 0.0, 0.5, 64, 'just'), (4, 0.5, 0.5, 66, 'to'), (4, 1.0, 1.0, 69, 'land'),
    (4, 2.0, 0.5, 66, 'here'), (4, 2.5, 0.5, 64, 'a'), (4, 3.0, 1.0, 62, 'gain'),
    (5, 0.0, 0.5, 67, 'Give'), (5, 0.5, 0.5, 69, 'me'), (5, 1.0, 0.5, 71, 'one'),
    (5, 1.5, 1.0, 71, 'white'), (5, 2.5, 0.5, 69, 'fea'), (5, 3.0, 1.0, 67, 'ther'),
    (6, 0.0, 0.5, 69, 'and'), (6, 0.5, 0.5, 71, 'a'), (6, 1.0, 1.0, 71, 'rea'),
    (6, 2.0, 0.5, 69, 'son'), (6, 2.5, 0.5, 67, 'to'), (6, 3.0, 1.0, 66, 'stay'),
    (7, 0.0, 0.5, 66, 'and'), (7, 0.5, 0.5, 69, "I'll"), (7, 1.0, 0.5, 71, 'find'),
    (7, 1.5, 0.5, 69, 'you'), (7, 2.0, 0.5, 66, 'in'), (7, 2.5, 0.5, 67, 'the'),
    (7, 3.0, 2.0, 71, 'mor'),                                    # ★클라이맥스 롱톤(마디 넘김)
    (8, 1.0, 0.5, 69, 'ning'), (8, 1.5, 0.5, 66, 'of'), (8, 2.0, 0.5, 64, 'a'),
    (8, 2.5, 0.5, 66, 'new'), (8, 3.0, 1.0, 62, 'day'),          # A7sus4 위 D = sus 여운
]

VERSE_MEL = [
    (1, 0.0, 0.5, 64, 'Rain'), (1, 0.5, 0.5, 67, 'on'), (1, 1.0, 0.5, 67, 'the'),
    (1, 1.5, 0.5, 69, 'lan'), (1, 2.0, 0.5, 67, 'tern'), (1, 2.5, 1.0, 64, 'glass'),
    (2, 0.0, 0.5, 64, 'the'), (2, 0.5, 0.5, 66, 'har'), (2, 1.0, 0.5, 69, 'bor'),
    (2, 1.5, 0.5, 67, 'turn'), (2, 2.0, 0.5, 66, 'ing'), (2, 2.5, 1.5, 64, 'gold'),
    (3, 0.0, 0.5, 66, 'a'), (3, 0.5, 0.5, 69, 'fid'), (3, 1.0, 0.5, 69, 'dle'),
    (3, 1.5, 0.5, 67, 'in'), (3, 2.0, 0.5, 69, 'the'), (3, 2.5, 0.5, 71, 'mar'),
    (3, 3.0, 1.0, 69, 'ket'),
    (4, 0.0, 0.5, 66, 'and'), (4, 0.5, 0.5, 66, 'a'), (4, 1.0, 0.5, 67, 'sto'),
    (4, 1.5, 0.5, 66, 'ry'), (4, 2.0, 0.5, 63, 'some'), (4, 2.5, 0.5, 64, 'one'),
    (4, 3.0, 1.5, 66, 'told'),                                   # B7b13 의 D#(63) 반음 색채
    (5, 0.0, 0.5, 64, "I've"), (5, 0.5, 0.5, 67, 'worn'), (5, 1.0, 0.5, 67, 'a'),
    (5, 1.5, 0.5, 69, 'hun'), (5, 2.0, 0.5, 67, 'dred'), (5, 2.5, 1.0, 64, 'names'),
    (6, 0.0, 0.5, 64, 'but'), (6, 0.5, 0.5, 66, 'I'), (6, 1.0, 0.5, 69, 'keep'),
    (6, 1.5, 0.5, 67, 'this'), (6, 2.0, 0.5, 66, 'one'), (6, 2.5, 0.5, 64, 'for'),
    (6, 3.0, 1.0, 62, 'you'),
    (7, 0.0, 0.5, 66, 'the'), (7, 0.5, 0.5, 69, 'one'), (7, 1.0, 0.5, 69, 'you'),
    (7, 1.5, 0.5, 71, 'called'), (7, 2.0, 0.5, 69, 'me'), (7, 2.5, 0.5, 66, 'soft'),
    (7, 3.0, 1.0, 64, 'ly'),
    (8, 0.0, 0.5, 63, 'when'), (8, 0.5, 0.5, 64, 'the'), (8, 1.0, 0.5, 66, 'sum'),
    (8, 1.5, 0.5, 64, 'mer'), (8, 2.0, 0.5, 63, 'was'), (8, 2.5, 0.5, 64, 'still'),
    (8, 3.0, 1.5, 66, 'new'),
]
...
PRE_MEL = [
    ...
    (3, 0.0, 0.5, 71, 'count'), (3, 0.5, 0.5, 71, 'the'), (3, 1.0, 0.5, 71, 'fea'),
    (3, 1.5, 0.5, 69, 'thers'), (3, 2.0, 0.5, 71, 'on'), (3, 2.5, 0.5, 69, 'the'),
    (3, 3.0, 1.0, 67, 'floor'),
    (4, 0.0, 1.0, 67, 'one'), (4, 1.0, 1.0, 69, 'two'), (4, 2.0, 0.5, 71, 'and'),
